...
extern void HalLcd_HW_ClearAllSpecChars(void);
extern void HalLcd_HW_Control(uint8 cmd);
extern void HalLcd_HW_Write(uint8 data);
extern void HalLcd_HW_SetContrast(uint8 value);
...
extern void halLcd_ConfigIO(void);
extern void halLcd_ConfigSPI(void);
